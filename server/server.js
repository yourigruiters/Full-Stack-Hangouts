...
io.on("connection", (socket) => {
  ...
  socket.on("create_room", (roomData) => {
    ...
    console.log(newRoom, "roomdata in server - Create room");
  ...
  socket.on("joining_room", (roomName) => {
    ...
    console.log("HOW MANY ARE JOINING?");
    ...
    console.log(
      roomData,
      "roomData from server before sending room_data to client"
    );
